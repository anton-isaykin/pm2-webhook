...
function processList(processes) {
    ...
    processes.forEach(function (proc) {
        ...
        if (!proc.pm2_env || !proc.pm2_env.env_webhook || !proc.pm2_env.env_webhook.port || !proc.pm2_env.versioning) {
            ...
            console.log('!proc.pm2_env', !proc.pm2_env);
            console.log('!proc.pm2_env.env_webhook', !proc.pm2_env.env_webhook);
            console.log('!proc.pm2_env.env_webhook.port', !proc.pm2_env.env_webhook.port);
            console.log('!proc.pm2_env.versioning', !proc.pm2_env.versioning);
            return;
        }
